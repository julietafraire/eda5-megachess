export class Rook {
    ...
    moveRook(positionBoard){
        let  arrayMoves =[];
        arrayMoves.push(this.moveFrontRook(positionBoard));
        arrayMoves.push(this.moveLeftRook(positionBoard));
        arrayMoves.push(this.moveRightRook(positionBoard));
        arrayMoves.push(this.moveBackRook(positionBoard));

        return arrayMoves;
    }

    moveFrontRook(positionBoard){
